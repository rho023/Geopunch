...
class Home_Fragment : Fragment(), OnMapReadyCallback {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        manuallayout = view.findViewById(R.id.automatic_layout)
        ...
        slider.onSlideCompleteListener = object : SlideToActView.OnSlideCompleteListener {
            override fun onSlideComplete(view: SlideToActView) {
                ...
                if(slider.isReversed) {
                    ...
                    slider.innerColor = context?.let { ContextCompat.getColor(it,
                        R.color.colorPrimary
                    ) }!!
                    slider.text = "       Check in >>"
                    slider.textColor = context?.let { ContextCompat.getColor(it,
                        R.color.colorPrimary
                    ) }!!
                    ...
                    slider.outerColor = context?.let { ContextCompat.getColor(it,
                        R.color.colorPrimary
                    ) }!!
                    slider.text = " << Check out      "
                    slider.textColor = context?.let { ContextCompat.getColor(it, R.color.white) }!!
                    slider.iconColor = context?.let { ContextCompat.getColor(it,
                        R.color.colorPrimary
                    ) }!!
                }
            }
